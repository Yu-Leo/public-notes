...
class WallTagsTestCase(TestCase):
    ...
    def test_get_categories(self):
        self.assertEqual({self.category_1, }, set(wall_tags.get_categories()))

    def test_get_tags(self):
        self.assertEqual({self.tag_1, }, set(wall_tags.get_tags()))

    def test_get_notes_count_for_author(self):
        self.assertEqual(1, wall_tags.get_notes_count_for_author(self.user_1))
        self.assertEqual(0, wall_tags.get_notes_count_for_author(self.user_2))

    def test_get_prev_note_in_category(self):
        self.assertIsNone(wall_tags.get_prev_note_in_category(self.note_1))
        self.assertEqual(self.note_1, wall_tags.get_prev_note_in_category(self.note_2))

    def test_get_next_note_in_category(self):
        self.assertEqual(self.note_3, wall_tags.get_next_note_in_category(self.note_2))
